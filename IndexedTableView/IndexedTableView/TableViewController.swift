...
class TableViewController: UITableViewController {
    ...
    //deklarasi indexOfNumbers sebagai array degan tipe string
    var indexOfNumbers = [String]()

    override func viewDidLoad() {
        super.viewDidLoad()
        //deklarasi all Numbers
        var allNumbers = "A R I F W O N G T A M V A N S"
    ...
    override func tableView(_ tableView: UITableView,sectionForSectionIndexTitle title: String, at index:Int) -> Int{
        //deklarasi var temp senagai pemyimpan data dari indexof NUmbers
